...
image_f_s = np.empty([3375, 3])   #68480/20 ~ 3375
#print("Empty image_f_s: ", image_f_s)
for i in range(3375):
    image_f_s[i] = image_f[i*20]
...
centroid_colors, closest_centroid_colors_index_arr = find_k_centroids(image_f_s, 16, max_iters=3)
...
rows_c2_back_to_orig = 45
cols_c2_back_to_orig = 75
...
skimage.io.imsave('beach_c_without_kmedoids_lib.png', image_f_s_c_with_kmedoids_clip_final)
